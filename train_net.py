...
def parse_args():
    ...
    parser.add_argument('--GPU', type=int, required=True, help="ID of GPU used for training/evaluation.",default=0)
    parser.add_argument('--RUN_NAME', type=str, required=True, help="Name of the run, used as directory name for storing results.",default="DAGM_run")
    parser.add_argument('--DATASET', type=str, required=True, help="Which dataset to use.",default="DAGM")
    parser.add_argument('--DATASET_PATH', type=str, required=True, help="Path to the dataset.",default="./datasets/DAGM/")

    parser.add_argument('--EPOCHS', type=int, required=True, help="Number of training epochs.",default=50)
