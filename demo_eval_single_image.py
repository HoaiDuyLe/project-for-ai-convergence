...
def plot_sample(image_name, image, segmentation, label, save_dir, decision=None, blur=True, plot_seg=False):
    ...
    plt.savefig(f"{save_dir}/result_.jpg", bbox_inches='tight', dpi=300)
    plt.close()
...
model_path = r"D:\\Chonnam\\Semester3\\ProjectForAI\\mixed-segdec-net-comind2021\\results\\DAGM\\N_ALL\\FOLD_10\\models\\best_state_dict.pth"
model.load_state_dict(torch.load(model_path, map_location=device))

# %%
img_path = r"D:\\Chonnam\\Semester3\\ProjectForAI\\mixed-segdec-net-comind2021\\datasets\\DAGM\\Class10\\Test\\0020.PNG"
...
plot_sample(image_name=img_path, image=image, segmentation=pred_seg, label=image, save_dir=r"./demo", decision=prediction, blur=True, plot_seg=False)
